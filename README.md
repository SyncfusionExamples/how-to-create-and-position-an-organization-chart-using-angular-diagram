...
A quick start Angular project that shows how to create and position an organization chart using the [Angular Diagram](https://www.syncfusion.com/diagram-sdk/angular-diagram) component. This project also includes a code snippet to bind JSON data and remote data source, customize the nodes and connectors in the diagram.
